...
function wp_bootstrap_pagination( $args = array() ) {
    ...
    $defaults = array(
        ...
        'first_string'    => __( '&laquo;', 'text-domain' ),
        'last_string'     => __( '&raquo;', 'text-domain' ),
...
function wp_bootstrap_pager()
{
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => __( '&laquo; Older posts', 'text-domain' ),
        'next_string'     => __( 'Newer posts &raquo;', 'text-domain' ),
