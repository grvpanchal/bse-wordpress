...
function bootstrap3_comment_form_fields( $fields ) {
    ...
    $fields   =  array(
        'author' => '<div class="col-xs-12 col-md-6"><div class="form-group comment-form-author">' . '<label for="author">' . __( 'Name' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
        ...
        'email'  => '<div class="col-xs-12 col-md-6"><div class="form-group comment-form-email"><label for="email">' . __( 'Email' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
